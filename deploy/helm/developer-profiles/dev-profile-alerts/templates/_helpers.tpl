...
{{- define "vss.alerts.serviceShort" -}}
{{- $short := index . "short" -}}
{{- $root := index . "root" -}}
...
{{/*
  ...
  For depKey "vss-agent", resolves agent.vss-agent then top-level vss-agent (agent umbrella).
*/}}
...
{{- define "vss.alerts.rtviScriptsConfigMapName" -}}
