...
{{/*
Resource basename aligned with dev-profile-base nims chart (nvidia-nemotron-nano-9b-v2)
...
{{- else }}
{{- default "nvidia-nemotron-nano-9b-v2" .Values.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
{{- end }}
